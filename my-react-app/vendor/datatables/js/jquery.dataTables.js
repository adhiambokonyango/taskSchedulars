...
(function(factory) {
  ...
  if (typeof define === "function" && define.amd) {
    // AMD
    define(["my-react-app/vendor/datatables/js/jquery"], function($) {
      ...
      if (!$) {
        $ =
          typeof window !== "undefined" // jQuery's factory checks for a global window
            ? require("my-react-app/vendor/datatables/js/jquery")
            : require("my-react-app/vendor/datatables/js/jquery")(root);
      }
